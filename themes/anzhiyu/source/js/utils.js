...
const NaoKuo = {
    ...
    try {
      if (!ipLoacation) {
        return new Promise((resolve, reject) => {
          ...
          var url = `https://apis.map.qq.com/ws/location/v1/ip?key=NMIBZ-22AKN-Z3MFE-SNUHT-ZMCAS-OXB7E&output=jsonp`;
          script.src = url;
  ...
  showWelcome: (ipStore) => {
    ...
    let timeChange,
      date = new Date();
    // 2026 新年祝福
    timeChange = "<span>[爆竹]新春快乐,万事顺遂[庆祝]</span>";
    ...
    🗺️您距离 <strong>站长</strong> 约有 <strong>${dist}</strong> 公里！<br>
    您当前IP地址为：<br>
